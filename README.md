...
| **Argon ONE V3** with Raspberry Pi 5 | Fan control through its RP2040 in the register protocol, handed over from the vendor's daemon (`mcu-takeover`); the case button (a double-tap) schedules an announced, cancellable poweroff | ✅ |
