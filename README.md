...
| **Argon NEO 5** with Raspberry Pi 5 | UPS monitoring over the internal USB header, UPS clock set (T15); fan and button are the Pi's own | ✅ wake scheduling untested on its firmware |
