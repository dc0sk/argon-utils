...
| `ARGON-UPS-HID-LIVE` | **The HID interface serves no data on firmware 113.** Feature reads return only the echoed report ID; no Input report arrives in 45 s idle; hiddev reads every value as 0. Descriptor valid, channel dormant | `observed` | OBS-2026-09-15-ups-hid-is-dormant |
